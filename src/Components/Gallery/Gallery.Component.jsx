...
import {LoadableImageComponent} from "../LoadableImage/LoadableImage.Componant";
...
export const GalleryComponent = ({
    ...
    const scrollPositionHandler = useCallback(() => {
        ...
        const isVisable = (currentDirection.isRtl
                      ...
                      || ''
                                    ...
                                    >
                                        <LoadableImageComponent
                                            ...
                                            alt={
                                                dataReturn(image, altInput) || t(`${translationPath}${alt}`)
                                            }
                                            src={
                                                (dataReturn(image, imageInput)
